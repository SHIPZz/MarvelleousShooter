...
namespace Unity.Cinemachine.Samples
{
    ...
    public class FlyAround : MonoBehaviour, Unity.Cinemachine.IInputAxisOwner
    {
        ...
        {
            axes.Add(new () { DrivenAxis = () => ref Sideways, Name = "Walk X", Hint = IInputAxisOwner.AxisDescriptor.Hints.X });
            axes.Add(new () { DrivenAxis = () => ref Forward, Name = "Forward" });
            axes.Add(new () { DrivenAxis = () => ref UpDown, Name = "Walk Y", Hint = IInputAxisOwner.AxisDescriptor.Hints.Y });
