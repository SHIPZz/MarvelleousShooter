...
namespace Unity.Cinemachine.Samples
{
    ...
    public abstract class SimplePlayerControllerBase : MonoBehaviour, Unity.Cinemachine.IInputAxisOwner
    {
        ...
        {
            axes.Add(new () { DrivenAxis = () => ref MoveX, Name = "Walk X", Hint = IInputAxisOwner.AxisDescriptor.Hints.X });
            axes.Add(new () { DrivenAxis = () => ref MoveZ, Name = "Walk Z", Hint = IInputAxisOwner.AxisDescriptor.Hints.Y });
    ...
    public class SimplePlayerController : SimplePlayerControllerBase
    {
        ...
        [Tooltip("Up direction for computing motion:\n"
            + "<b>Player</b>: Walk in the Player's local XZ plane.\n"
            + "<b>World</b>: Walk in global XZ plane.")]
