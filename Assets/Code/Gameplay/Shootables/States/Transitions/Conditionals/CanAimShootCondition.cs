...
namespace Code.Gameplay.Shootables.States.Transitions.Conditionals
{
    public class CanAimShootCondition : ICondition
    {
        ...
        public CanAimShootCondition(IInputService inputService, IShootService shootService, GameContext game)
        {
        ...
        public bool IsMet()
        {
            ...
            {
                return shootable.isShooting && shootable.isAiming && shootable.isAimable;
            }
