...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Movement.MovementSpeed movementSpeed { get { return (Code.ECS.Gameplay.Features.Movement.MovementSpeed)GetComponent(GameComponentsLookup.MovementSpeed); } }
    ...
    public GameEntity AddMovementSpeed(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Movement.MovementSpeed)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Movement.MovementSpeed));
