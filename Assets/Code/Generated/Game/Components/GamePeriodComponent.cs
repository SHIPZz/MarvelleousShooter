...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Statuses.Period period { get { return (Code.ECS.Gameplay.Features.Statuses.Period)GetComponent(GameComponentsLookup.Period); } }
    ...
    public GameEntity AddPeriod(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Statuses.Period)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Statuses.Period));
