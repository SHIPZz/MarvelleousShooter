...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.TargetCollection.TargetLimit targetLimit { get { return (Code.ECS.Gameplay.Features.TargetCollection.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.TargetCollection.TargetLimit)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.TargetCollection.TargetLimit));
