...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Loot.PickupRadius pickupRadius { get { return (Code.ECS.Gameplay.Features.Loot.PickupRadius)GetComponent(GameComponentsLookup.PickupRadius); } }
    ...
    public GameEntity AddPickupRadius(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Loot.PickupRadius)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Loot.PickupRadius));
