...
public partial class GameEntity {
    ...
    public Code.ECS.Common.Id id { get { return (Code.ECS.Common.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public GameEntity AddId(int newValue) {
        ...
        var component = (Code.ECS.Common.Id)CreateComponent(index, typeof(Code.ECS.Common.Id));
