...
public partial class GameEntity {
    ...
    public Code.ECS.Common.TransformComponent transform { get { return (Code.ECS.Common.TransformComponent)GetComponent(GameComponentsLookup.Transform); } }
    ...
    public GameEntity AddTransform(UnityEngine.Transform newValue) {
        ...
        var component = (Code.ECS.Common.TransformComponent)CreateComponent(index, typeof(Code.ECS.Common.TransformComponent));
