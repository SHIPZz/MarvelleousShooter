...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Cooldown.Cooldown cooldown { get { return (Code.ECS.Gameplay.Features.Cooldown.Cooldown)GetComponent(GameComponentsLookup.Cooldown); } }
    ...
    public GameEntity AddCooldown(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Cooldown.Cooldown)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Cooldown.Cooldown));
