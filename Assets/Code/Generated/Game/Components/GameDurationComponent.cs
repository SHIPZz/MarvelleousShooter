...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Statuses.Duration duration { get { return (Code.ECS.Gameplay.Features.Statuses.Duration)GetComponent(GameComponentsLookup.Duration); } }
    ...
    public GameEntity AddDuration(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Statuses.Duration)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Statuses.Duration));
