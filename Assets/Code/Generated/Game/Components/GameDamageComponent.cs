...
public partial class GameEntity {
    ...
    public Code.ECS.Common.Damage damage { get { return (Code.ECS.Common.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.ECS.Common.Damage)CreateComponent(index, typeof(Code.ECS.Common.Damage));
