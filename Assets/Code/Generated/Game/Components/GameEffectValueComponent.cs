...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Effects.EffectValue effectValue { get { return (Code.ECS.Gameplay.Features.Effects.EffectValue)GetComponent(GameComponentsLookup.EffectValue); } }
    ...
    public GameEntity AddEffectValue(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Effects.EffectValue)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Effects.EffectValue));
