...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Movement.HorizontalRotation horizontalRotation { get { return (Code.ECS.Gameplay.Features.Movement.HorizontalRotation)GetComponent(GameComponentsLookup.HorizontalRotation); } }
    ...
    public GameEntity AddHorizontalRotation(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Movement.HorizontalRotation)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Movement.HorizontalRotation));
