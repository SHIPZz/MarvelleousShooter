...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Cooldown.CooldownLeft cooldownLeft { get { return (Code.ECS.Gameplay.Features.Cooldown.CooldownLeft)GetComponent(GameComponentsLookup.CooldownLeft); } }
    ...
    public GameEntity AddCooldownLeft(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Cooldown.CooldownLeft)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Cooldown.CooldownLeft));
