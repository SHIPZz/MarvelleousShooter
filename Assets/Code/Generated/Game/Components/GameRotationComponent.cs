...
public partial class GameEntity {
    ...
    public Code.ECS.Common.Rotation rotation { get { return (Code.ECS.Common.Rotation)GetComponent(GameComponentsLookup.Rotation); } }
    ...
    public GameEntity AddRotation(UnityEngine.Quaternion newValue) {
        ...
        var component = (Code.ECS.Common.Rotation)CreateComponent(index, typeof(Code.ECS.Common.Rotation));
