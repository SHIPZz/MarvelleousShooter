...
public partial class GameEntity {
    ...
    public Code.ECS.Common.WorldPosition worldPosition { get { return (Code.ECS.Common.WorldPosition)GetComponent(GameComponentsLookup.WorldPosition); } }
    ...
    public GameEntity AddWorldPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.ECS.Common.WorldPosition)CreateComponent(index, typeof(Code.ECS.Common.WorldPosition));
