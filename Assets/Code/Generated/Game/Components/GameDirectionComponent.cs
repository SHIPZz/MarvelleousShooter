...
public partial class GameEntity {
    ...
    public Code.ECS.Common.Direction direction { get { return (Code.ECS.Common.Direction)GetComponent(GameComponentsLookup.Direction); } }
    ...
    public GameEntity AddDirection(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.ECS.Common.Direction)CreateComponent(index, typeof(Code.ECS.Common.Direction));
