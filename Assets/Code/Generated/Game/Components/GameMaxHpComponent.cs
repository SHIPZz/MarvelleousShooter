...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Lifetime.MaxHp maxHp { get { return (Code.ECS.Gameplay.Features.Lifetime.MaxHp)GetComponent(GameComponentsLookup.MaxHp); } }
    ...
    public GameEntity AddMaxHp(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Lifetime.MaxHp)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Lifetime.MaxHp));
