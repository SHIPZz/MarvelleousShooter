...
public partial class GameEntity {
    ...
    public Code.ECS.Common.ViewPath viewPath { get { return (Code.ECS.Common.ViewPath)GetComponent(GameComponentsLookup.ViewPath); } }
    ...
    public GameEntity AddViewPath(string newValue) {
        ...
        var component = (Code.ECS.Common.ViewPath)CreateComponent(index, typeof(Code.ECS.Common.ViewPath));
