...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.TargetCollection.Radius radius { get { return (Code.ECS.Gameplay.Features.TargetCollection.Radius)GetComponent(GameComponentsLookup.Radius); } }
    ...
    public GameEntity AddRadius(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.TargetCollection.Radius)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.TargetCollection.Radius));
