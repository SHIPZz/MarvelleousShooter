...
public partial class GameEntity {
    ...
    public Code.ECS.Common.ViewPrefab viewPrefab { get { return (Code.ECS.Common.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public Code.ECS.View.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Code.ECS.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.ECS.Common.ViewPrefab)CreateComponent(index, typeof(Code.ECS.Common.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(Code.ECS.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Code.ECS.Common.ViewPrefab)CreateComponent(index, typeof(Code.ECS.Common.ViewPrefab));
        component.Value = newValue;
