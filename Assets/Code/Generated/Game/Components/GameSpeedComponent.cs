...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Movement.Speed speed { get { return (Code.ECS.Gameplay.Features.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Movement.Speed)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Movement.Speed));
