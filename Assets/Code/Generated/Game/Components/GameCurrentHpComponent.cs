...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Lifetime.CurrentHp currentHp { get { return (Code.ECS.Gameplay.Features.Lifetime.CurrentHp)GetComponent(GameComponentsLookup.CurrentHp); } }
    ...
    public GameEntity AddCurrentHp(float newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Lifetime.CurrentHp)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Lifetime.CurrentHp));
