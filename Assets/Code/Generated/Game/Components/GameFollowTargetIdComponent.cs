...
public partial class GameEntity {
    ...
    public Code.ECS.Gameplay.Features.Follow.FollowTargetId followTargetId { get { return (Code.ECS.Gameplay.Features.Follow.FollowTargetId)GetComponent(GameComponentsLookup.FollowTargetId); } }
    ...
    public GameEntity AddFollowTargetId(int newValue) {
        ...
        var component = (Code.ECS.Gameplay.Features.Follow.FollowTargetId)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Follow.FollowTargetId));
