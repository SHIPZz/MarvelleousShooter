...
public partial class GameEntity {
    ...
    public Code.ECS.Common.EntityLink entityLink { get { return (Code.ECS.Common.EntityLink)GetComponent(GameComponentsLookup.EntityLink); } }
    ...
    public GameEntity AddEntityLink(int newValue) {
        ...
        var component = (Code.ECS.Common.EntityLink)CreateComponent(index, typeof(Code.ECS.Common.EntityLink));
