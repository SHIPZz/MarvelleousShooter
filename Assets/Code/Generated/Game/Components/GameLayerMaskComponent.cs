...
public partial class GameEntity {
    ...
    public Code.ECS.Common.LayerMaskComponent layerMask { get { return (Code.ECS.Common.LayerMaskComponent)GetComponent(GameComponentsLookup.LayerMask); } }
    ...
    public GameEntity AddLayerMask(int newValue) {
        ...
        var component = (Code.ECS.Common.LayerMaskComponent)CreateComponent(index, typeof(Code.ECS.Common.LayerMaskComponent));
