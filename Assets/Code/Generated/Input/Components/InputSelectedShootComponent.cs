...
public partial class InputEntity {
    ...
    public Code.Gameplay.Heroes.Enums.ShootInputTypeId SelectedShoot { get { return selectedShoot.Value; } }
    public bool hasSelectedShoot { get { return HasComponent(InputComponentsLookup.SelectedShoot); } }

    public InputEntity AddSelectedShoot(Code.Gameplay.Heroes.Enums.ShootInputTypeId newValue) {
    ...
    public InputEntity ReplaceSelectedShoot(Code.Gameplay.Heroes.Enums.ShootInputTypeId newValue) {
        var index = InputComponentsLookup.SelectedShoot;
        var component = (Code.ECS.Gameplay.Features.Input.SelectedShoot)CreateComponent(index, typeof(Code.ECS.Gameplay.Features.Input.SelectedShoot));
        component.Value = newValue;
