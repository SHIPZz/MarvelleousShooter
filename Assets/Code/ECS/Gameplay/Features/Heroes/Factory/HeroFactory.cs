    ...
    public class HeroFactory : IHeroFactory
    {
        ...
        public GameEntity Create(Transform parent, Vector3 at, Quaternion rotation)
        {
            ...
            GameEntity heroEntity = CreateEntity
                ...
                .AddAvailableGuns(worldData.PlayerData.AvailableGuns)
                .AddCurrentGunTypeId(worldData.PlayerData.LastGunId)
           ...
           EntityBehaviour createdView =  _entityViewFactory.CreateViewForEntityFromPrefab(heroEntity);

           createdView.transform.position = at;
